...
class Navigation {
    ...
    renderYears(container, years, animate = true) {
        ...
        container.innerHTML = '';
        container.classList.add('cards-grid'); // Ensure grid class is present
        ...
        years.forEach((year, index) => {
            ...
            // Assign Bento classes based on index/importance
            if (index === 0) bentoClass = 'card-hero';
            else if (index % 5 === 3) bentoClass = 'card-wide';
            else if (index % 7 === 0 && index !== 0) bentoClass = 'card-tall';
            ...
            if (bentoClass) card.classList.add(bentoClass);

            // Add specific visuals for Year cards
            card.style.background = `linear-gradient(135deg, ${this.getYearColor(index)} 0%, rgba(255,255,255,0.1) 100%)`;
        ...
        if (window.motionCoordinator) {
            ...
            window.motionCoordinator.staggerElements(items, 'animate-entrance-scale');
        }
    ...
    showSubjects(year, module) {
        ...
        this.renderWithTransition(container, () => {
            ...
            module.subjects.forEach(subject => {
                // Use standard cards for subjects
    ...
    showLectures(year, module, subject) {
        ...
        this.renderWithTransition(container, () => {
            ...
            subject.lectures.forEach(lecture => {
                // Create skeleton CARD instead of list item
